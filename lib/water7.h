...
#define WATER7_PARAMS_OFFSET			(64 + 128)
...
#define WATER7_PAR_COUNT				10						//	parameters count (max 64)
...
#define WATER7_CALLBACK_BUF_SIZE		128										//	callbak buffer size
